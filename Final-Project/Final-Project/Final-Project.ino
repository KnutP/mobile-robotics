...
***********************************
  Arkin-Lab04.ino
  Knut Peterson 2/2/20
  Garrett Jacobs 2/2/20

  This program will introduce Braitenberg and light homing behaviors for the robot Arkin.
  The Braitenberg behaviors are love, fear, explorer, and aggression.
  love - the robot drives forward until it sees a light, then turns toward it and slows down.
  fear - the robot remains still until it sees a light, then drives away from  it.
  explorer - the robot drives forward until it sees a light, then turns away from it.
  aggression - the robot remains still until it sees a light, then drives toward it.
...
/* The fear() Braitenberg behavior negatively maps the two photoresistor readings
 *  to the motor speeds on their respective sides of the robot.
*/
void fear() {
...
/* The explorer() Braitenberg behavior negatively maps the two photoresistor readings
 *  to the motor speeds on the opposite side of the robot.
*/
void explorer() {
...
/* The aggression() Braitenberg behavior positively maps the two photoresistor readings
 *  to the motor speeds on the opposite side of the robot.
*/
void aggression() {
